...
@WebServlet("/redireccionar-admin")
public class RedireccionarAdminServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            adminDAO.close();
            req.getRequestDispatcher("actualizar-admin.jsp").forward(req, resp);
        } catch (Exception e) {
